          ...
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                ...
                const storedTheme = localStorage.getItem('editor-storage');
                let currentTheme = 'light'; // Default theme
                
                try {
                  if (storedTheme) {
                    const parsed = JSON.parse(storedTheme);
                    if (parsed.state && parsed.state.themeState && parsed.state.themeState.currentMode) {
                      currentTheme = parsed.state.themeState.currentMode;
                    } else {
                ...
                // Terapkan kelas dark pada <html> jika tema adalah 'dark'
