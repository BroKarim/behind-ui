...
const NextInt = () => {
  ...
  return (
    <>
      <div className="z-50 flex h-full flex-col items-center justify-between overflow-hidden bg-white px-4 md:h-screen ">
        <motion.div className="flex w-full items-center justify-between p-6 px-10">
          <div className="flex flex-1 text-lg font-medium text-black md:text-2xl">NexInt</div>
