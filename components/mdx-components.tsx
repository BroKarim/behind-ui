...
const components = {
  ...
  a: ({ className, ...props }: React.HTMLAttributes<HTMLAnchorElement>) => <CustomLink className={cn("font-medium underline underline-offset-4", className)} {...props} />,
  ...
  ul: ({ className, ...props }: React.HTMLAttributes<HTMLUListElement>) => <ul className={cn("ml-6 list-disc", className)} {...props} />,
  ol: ({ className, ...props }: React.HTMLAttributes<HTMLOListElement>) => <ol className={cn("ml-6 list-decimal", className)} {...props} />,
  ...
  pre: ({
    ...
    return (
      <>
        <pre className={cn("mb-4 mt-6 max-h-[650px] overflow-x-auto rounded-lg border  bg-zinc-800 py-4 md:px-2", className)} {...props} />
...
export function Mdx({ code, className }: MDXProps) {
  ...
  return (
    <article className={cn("mx-auto flex-col  items-center md:container md:max-w-full", className)}>
