...
export function Banner() {
  return (
    <div className="group relative top-0 border  bg-gradient-to-tr from-white to-stone-100 py-3 font-mono text-white transition-all duration-300 dark:from-zinc-900 dark:to-zinc-950 md:py-0">
