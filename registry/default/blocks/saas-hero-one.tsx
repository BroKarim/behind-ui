        ...
        <div className="flex min-h-screen flex-col font-sans">
          <div className=" space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
            <div className=" flex flex-col items-center  gap-6">
              <h1 className="flex max-w-[64rem] flex-col justify-center text-center text-5xl font-bold  md:h-max md:flex-row md:text-6xl">
                <span className="bg-gradient-to-r from-red-600 to-amber-600 bg-clip-text ">
                  Power Your Email Marketing Campaigns with Ease and Efficiency
                </span>{" "}
                {/* for OpenAI */}
              </h1>
          ...
          <GridPattern
            ...
            y={-1}
            className={cn(
              "-z-10 stroke-gray-300 [mask-image:linear-gradient(to_bottom_right,white,transparent,transparent)] ",
            )}
          />
        </div>
      </div>
...
export function Header() {
  return (
    <>
      <header className="supports-backdrop-blur:bg-background/80 sticky top-0 z-40 w-full border-b bg-background backdrop-blur">
            ...
            <nav className="flex items-center gap-2">
              <Link
                ...
                className={cn(
                  ...
                  "bg-gradient-to-r from-red-600 to-amber-600 px-4 text-white",
                )}
              >
                Get Started
              </Link>
      ...
      <div className="mr-4 hidden md:flex">
        ...
        <NavigationMenu>
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              <Link href="https://docs.llm.report">
